const translations = {
  en: {
    ...
    "site.tagline": "Access agricultural services, resources, and support to help you thrive.",
    "langSwitch": "العربية",
    "login": "Login",
    ...
    "nav.home": "Home",
    "nav.about": "About",
    "nav.about.overview": "Ministry Overview",
    "nav.about.vision": "Vision & Mission",
    "nav.about.leadership": "Leadership",
    "nav.about.plan": "Strategic Plan",
    ...
    "nav.services.exportCert": "Export Certification",
    "nav.services.training": "Training & Workshops",
    "nav.resources": "Resources",
    "nav.resources.publications": "Publications",
    "nav.resources.studies": "Research Studies",
    "nav.resources.guidelines": "Guidelines",
    ...
    "quickLinks.resources.title": "Resources & Publications",
    ...
    "services.fisheries": "Fisheries & Aquaculture",
    ...
    "resources.formats": "Resource Formats",
    ...
    "directory.central": "Central Administration",
    "directory.north": "Northern Governorates",
    "directory.centralGov": "Central Governorates",
  ...
  ar: {
    // Common
    "site.name": "وزارة الزراعة الفلسطينية",
    "site.slogan": "دعم الزراعة المستدامة في فلسطين",
    "site.tagline": "الوصول إلى الخدمات الزراعية والموارد والدعم لمساعدتك على الازدهار.",
    "langSwitch": "English",
    "login": "تسجيل الدخول",
    ...
    "nav.about.overview": "نبذة عن الوزارة",
    "nav.about.vision": "الرؤية والرسالة",
    "nav.about.leadership": "القيادة",
    "nav.about.plan": "الخطة الاستراتيجية",
    "nav.services": "الخدمات",
    "nav.services.farmer": "دعم المزارعين",
    "nav.services.veterinary": "الخدمات البيطرية",
    "nav.services.licensing": "التراخيص",
    "nav.services.research": "البحوث الزراعية",
    "nav.services.plantProtection": "وقاية النباتات",
    "nav.services.exportCert": "شهادات التصدير",
    "nav.services.training": "التدريب وورش العمل",
    "nav.resources": "الموارد",
    "nav.resources.publications": "المنشورات",
    "nav.resources.studies": "الدراسات البحثية",
    "nav.resources.guidelines": "الإرشادات",
    ...
    "services.fisheries": "الثروة السمكية وتربية الأحياء المائية",
    ...
    "resources.formats": "تنسيقات الموارد",
    ...
    "directory.central": "الإدارة المركزية",
    "directory.north": "المحافظات الشمالية",
    "directory.centralGov": "المحافظات الوسطى",
    ...
    "footer.rights": "© 2025 وزارة الزراعة الفلسطينية. جميع الحقوق محفوظة.",
...
export const getTranslation = (language: Languages, key: TranslationKey): string => {
